...
class Interrupt {
  public:
    ...
    OpenFileId Open(char *name); //add Open called by system call interface

    int Write(char *buffer, int size, OpenFileId id); //add Write called by system call interface

    int Read(char *buffer, int size, OpenFileId id); //add Read called by system call interface

    int Close(OpenFileId id); //add Close called by system call interface
